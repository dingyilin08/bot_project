...
async def content(con_arr0, con_arr1, openid, group_openid=None):
    ...
    elif con_arr0 in ('专属组合', '异火融合', '本源合道'):
        return await role_special_combine(uid, con_arr1)
    elif con_arr0 in ('专属排行榜', '异火排行榜', '问道排行榜'):
