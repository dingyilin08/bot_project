            ...
            async with connect_mysql() as conn:
                async with conn.cursor() as cursor:
                    ...
                    if result[0] == 1:
                        ...
                        output += "您还未选择您的初始角色！\n请发送**选择角色**来选择您的初始角色！\n\n"
                        output += "**待选角色：**\n"
                        output += "> ◇<qqbot-cmd-enter text='角色介绍 萧炎' />：异火焚天/斗帝传承\n"
                        output += "> ◇<qqbot-cmd-enter text='角色介绍 王林' />：禁制大师/生死轮回\n"
                        output += "> ◇<qqbot-cmd-enter text='角色介绍 韩立' />：掌天瓶主/遁术无双\n"
                        output += "> ◇<qqbot-cmd-enter text='角色介绍 石昊' />：独断万古/至尊骨\n"
                        output += "> ◇<qqbot-cmd-enter text='角色介绍 叶凡' />：圣体无双/九秘传承\n"
                        output += "> ◇<qqbot-cmd-enter text='角色介绍 孟川' />：刀意通神/雷霆灭世\n\n"
